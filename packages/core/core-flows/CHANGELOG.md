...
- [#15856](https://github.com/medusajs/medusa/pull/15856) [`631c2f2311f1931fe4a688d8796a7a81c2191243`](https://github.com/medusajs/medusa/commit/631c2f2311f1931fe4a688d8796a7a81c2191243) Thanks [@d3v07](https://github.com/d3v07)! - fix(core-flows): only emit RETURN_RECEIVED from createAndCompleteReturnOrderWorkflow when receive_now is true, so requested-only returns no longer trigger the received event
